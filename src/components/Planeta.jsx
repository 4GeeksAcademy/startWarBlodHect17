...
export const Planeta = (props) => {
    ...
    const { dispatch, id, planet, type } = props;
    ...
    return (
        <div className="card m-2 shadow-sm" style={{ minWidth: "18rem", maxWidth: "18rem", flexShrink: 0 }}>
            <img src="https://placeholder.pics/svg/300x200" className="card-img-top" alt={planet} />
            <div className="card-body d-flex flex-column justify-content-between">
                <div>
                    <h5 className="card-title text-dark">{planet}</h5>
